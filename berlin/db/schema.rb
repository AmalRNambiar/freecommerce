...
ActiveRecord::Schema.define(version: 2020_02_19_054830) do
  ...
  create_table "products", id: :serial, force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_spree_products_on_permalink"
  ...
  create_table "reimbursements", id: :serial, force: :cascade do |t|
    ...
    t.index ["number"], name: "index_reimbursements_on_number", unique: true

class SpreeOneTwo < ActiveRecord::Migration[4.2]
  def up
    ...
    add_index :configurations, [:name, :type], name: 'index_spree_configurations_on_name_and_type'
    ...
    add_index :line_items, [:order_id],   name: 'index_spree_line_items_on_order_id'
    add_index :line_items, [:variant_id], name: 'index_spree_line_items_on_variant_id'
    ...
    add_index :option_values_variants, [:variant_id],                   name: 'index_spree_option_values_variants_on_variant_id'
    ...
    add_index :orders, [:number], name: 'index_spree_orders_on_number'
    ...
    add_index :preferences, [:key], name: 'index_spree_preferences_on_key', unique: true
    ...
    add_index :products_taxons, [:product_id], name: 'index_spree_products_taxons_on_product_id'
    add_index :products_taxons, [:taxon_id],   name: 'index_spree_products_taxons_on_taxon_id'
    ...
    add_index :roles_users, [:role_id], name: 'index_spree_roles_users_on_role_id'
    add_index :roles_users, [:user_id], name: 'index_spree_roles_users_on_user_id'
    ...
    add_index :variants, [:product_id], name: 'index_spree_variants_on_product_id'
